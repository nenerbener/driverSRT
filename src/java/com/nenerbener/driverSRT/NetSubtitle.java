...
public class NetSubtitle {
    ...
    */
    ...
    public String getTrackURL(Method method) throws UnsupportedEncodingException {
        ...
        switch (method) {
            ...
            case YouTubeSignature:        
                ...
                // Bug fix 0.7.7: any signed paramaters, i.e., included in sparams
                for (String k : params.keySet())
                    s += k + "=" + params.get(k) + "&";
                        
                s += "name=" + URLEncoder.encode(this.name, "UTF-8") +
                    "&lang=" + URLEncoder.encode(this.lang, "UTF-8") +
                    //"&v=" + URLEncoder.encode(this.getId(), "UTF-8") +
        ...
        switch (method) {
            ...
            case YouTubeSignature:
                ...
                */
                ...
                s += "name=" + URLEncoder.encode(source.name, "UTF-8") +
                    "&lang=" + URLEncoder.encode(source.lang, "UTF-8") +
                    "&tlang=" + URLEncoder.encode(this.lang, "UTF-8") +
                    //"&v=" + URLEncoder.encode(source.getId(), "UTF-8") +
                    "&type=track";
    ...
    public static String getListURL(Method method, HashMap<String, String> params) throws UnsupportedEncodingException {
        String s;
        switch (method) {
            case Google:
            ...
            case YouTubeSignature:
                ...
                * http://www.youtube.com/api/timedtext?
                * 
                *      (any signed paramaters, i.e., included in sparams)
                * 
                *      asrs=1&
                *      tlangs=1&
                *      type=list
